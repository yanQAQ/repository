              ...
              <el-row v-for="item in props.row.children" :key="item.id">
                <el-col :span="5">
                  <el-tag
                    closable
                    type="primary"
                    @close="handleClose(props.row.id,item.id);props.row.children.splice(props.row.children.findIndex(e=>e.id===item.id),1)"
                  ...
                  <el-row v-for="item2 in item.children" :key="item2.id">
                    <el-col :span="6">
                      <el-tag
                        closable
                        type="success"
                        @close="handleClose(props.row.id,item2.id);item.children.splice(item.children.findIndex(e=>e.id===item2.id), 1)"
                    ...
                    <el-col :span="18">
                      <el-tag
                        ...
                        :key="item3.id"
                        @close="handleClose(props.row.id,item3.id);item2.children.splice(item2.children.findIndex(e=>e.id===item3.id), 1)"
